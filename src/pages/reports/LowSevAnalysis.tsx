import { ArrowRight, FolderOpen, TrendingUp, BarChart3, ListChecks } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <ReportSection
        ...
        description="Key performance indicators for this report period"
      >
        <SummaryMetrics
          metrics={[
            { value: "137", label: "Total Low Sev Tickets" },
            { value: "16", label: "Open Tickets", variant: "warning" },
            { value: "4.7h", label: "SDE Hrs Saved by Auto Resolving", variant: "success" },
          ]}
        />
      </ReportSection>

      {/* Section 3: Summary / Trends */}
      <ReportSection
        icon={TrendingUp}
        title="Ticket Trends"
        description="Daily ticket count by category - Click legend items to show/hide categories"
      >
        <div className="h-80">
      ...
      <ReportSection
        ...
        description="Daily breakdown of incoming, open, and resolved tickets"
      >
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <ReportSection
        icon={ListChecks}
        title="Action Items"
        description="Click on any category to view all tickets in that category"
      >
